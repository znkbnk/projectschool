...
// --------------------------------------------------------------------
// working webhook 20 of June 2024
...
//         if (user.isAdmin) {
//           console.log("Admin user detected, skipping subscription update.");
//           return res.status(200).send("Admin user, no subscription update needed.");
//         }
...
//         res.status(200).send("Subscription status updated");
//       })
//       .catch((error) => {
